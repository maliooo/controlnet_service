...
image_path = Path(__file__).parent / "images" / "bedroom.jpg"
# 读取为RGB格式
...
# 保存结果
output_path = OUTPUT_DIR / "semantic_segmentation_result.png"
...
combined_image.save(OUTPUT_DIR / "combined_result.png")
